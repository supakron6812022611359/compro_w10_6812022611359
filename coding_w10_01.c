...
int main() {
    int a, b;   //ประกาศตัวแปร a,b
    float score, sum = 0, avg;  //ประกาศตัวแปร score, sum, avg โดยกำหนดค่าเริ่มต้นของ sum = 0
    ...
    for(b = 1; b <= a; b++ ) {  //ลูป for โดยกำหนดค่าเริ่มต้น b = 1, เงื่อนไข b <= a, เพิ่มค่า b ทีละ 1
