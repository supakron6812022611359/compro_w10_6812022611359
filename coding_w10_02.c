...
int main() {
    float scores[3][3]; // ประกาศตัวแปร scores เป็น array 2 มิติ ขนาด 3x3
    float sum_student[3]    // ประกาศตัวแปร sum_student เป็น array จำนวน 3 ค่า
        = {0, 0, 0};    // ค่าเริ่มต้นเป็น 0
    float sum_subject[3]    // ประกาศตัวแปร sum_subject เป็น array จำนวน 3 ค่า
        = {0, 0, 0};    // ค่าเริ่มต้นเป็น 0
    char * subjects[] = {"Math", "Physics", "Chemistry"};   // ประกาศตัวแปร subjects เป็น array ของ string
    ...
    for(a = 0; a < 3; a++) {    // ลูป for กำหนดให้ a = 0 ถ้า a < 3 ให้เพิ่มค่า a ทีละ 1
        ...
        for(b = 0; b < 3; b++) {    // ลูป for กำหนดให้ b = 0 ถ้า b < 3 ให้เพิ่มค่า b ทีละ 1
            ...
            scanf("%f", &scores[a][b]);  // ใส่ค่าตัวแปร scores[a][b]
